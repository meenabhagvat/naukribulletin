...
SOURCES = [
    ...
    # ── MISSING STATE PSCs ─────────────────────────────────────────────────
    {
        "url": "https://tgpsc.telangana.gov.in/rss.xml",
    ...
    {
        "url": "https://psc.ap.gov.in/rss.xml",
    ...
    {
        "url": "https://wbpsc.gov.in/rss.xml",
    ...
    {
        "url": "https://www.hppsc.hp.gov.in/hppsc/rss.xml",
        "fallback_url": "https://www.hppsc.hp.gov.in/hppsc/Advertisements.aspx",
        "type": "rss",
    ...
    {
        "url": "https://www.jpsc.gov.in/rss.xml",
    ...
    {
        "url": "https://psc.cg.gov.in/rss.xml",
    ...
    {
        "url": "https://dsssb.delhi.gov.in/rss.xml",
        "fallback_url": "https://dsssb.delhi.gov.in/dsssbportal/AdvertisementPage.do",
        "type": "rss",
        "dept": "DSSSB (Delhi)",
        "category": "state",
        "state": "Delhi",
    ...
    # ── PSUs / CENTRAL ORGS ────────────────────────────────────────────────
    {
        "url": "https://www.ntpc.co.in/rss.xml",
    ...
    {
        "url": "https://www.ongcindia.com/wps/wcm/connect/ongc/home/rss.xml",
        "fallback_url": "https://www.ongcindia.com/wps/wcm/connect/ongc/home/career",
        "type": "rss",
        "dept": "ONGC",
        "category": "engineering",
        "priority": 2,
    ...
    {
        "url": "https://nalco.gov.in/rss.xml",
    ...
    {
        "url": "https://www.coalindia.in/rss.xml",
    ...
    {
        "url": "https://recpdcl.in/rss.xml",
        "fallback_url": "https://recpdcl.in/careers",
        "type": "rss",
        "dept": "REC",
        "category": "engineering",
        "priority": 2,
    ...
    {
        "url": "https://www.nabard.org/rss.xml",
        "fallback_url": "https://www.nabard.org/content.aspx?id=572",
        "type": "rss",
        "dept": "NABARD",
        "category": "banking",
        "priority": 1,
    ...
    {
        "url": "https://www.pnbindia.in/rss.xml",
        "fallback_url": "https://www.pnbindia.in/recruitmentnotices.html",
        "type": "rss",
        "dept": "PNB",
        "category": "banking",
        "priority": 2,
    ...
    {
        "url": "https://www.bankofbaroda.in/rss.xml",
    ...
    # ── HIGH COURTS ────────────────────────────────────────────────────────
    {
        "url": "https://www.allahabadhighcourt.in/rss.xml",
    ...
    {
        "url": "https://www.mphc.gov.in/rss.xml",
    ...
    {
        "url": "https://hcraj.nic.in/rss.xml",
        "fallback_url": "https://hcraj.nic.in/Recruitment.aspx",
        "type": "rss",
    ...
    # ── HEALTH / MEDICAL ───────────────────────────────────────────────────
    {
        "url": "https://www.esic.nic.in/rss.xml",
    ...
    {
        "url": "https://www.aiims.edu/rss.xml",
    ...
    {
        "url": "https://icmr.gov.in/rss.xml",
        "fallback_url": "https://icmr.gov.in/recruitment.html",
        "type": "rss",
        "dept": "ICMR",
        "category": "teaching",
        "priority": 2,
    ...
    {
        "url": "https://www.nhm.gov.in/rss.xml",
    ...
    {
        "url": "https://www.ugc.gov.in/rss.xml",
        "fallback_url": "https://www.ugc.gov.in/notice_detail.aspx?id=MTc=",
        "type": "rss",
        "dept": "UGC",
        "category": "teaching",
        "priority": 1,
    ...
    {
        "url": "https://recruitment.nta.ac.in/rss.xml",
    ...
    {
        "url": "https://www.iitd.ac.in/rss.xml",
        "fallback_url": "https://www.iitd.ac.in/jobs",
        "type": "rss",
        "dept": "IIT Delhi",
        "category": "teaching",
        "priority": 2,
    ...
    {
        "url": "https://www.du.ac.in/rss.xml",
    ...
    {
        "url": "https://bsf.gov.in/rss.xml",
        "fallback_url": "https://bsf.gov.in/recruitment.html",
        "type": "rss",
        "dept": "BSF",
        "category": "police",
        "priority": 1,
    ...
    {
        "url": "https://www.cisf.gov.in/rss.xml",
        "fallback_url": "https://www.cisf.gov.in/recruitment.html",
        "type": "rss",
        "dept": "CISF",
        "category": "police",
        "priority": 1,
    ...
    {
        "url": "https://itbpolice.nic.in/rss.xml",
    ...
    {
        "url": "https://ssb.nic.in/rss.xml",
        "fallback_url": "https://ssb.nic.in/SSBUINew/Recruitment/RecruitmentAdvertisement.aspx",
        "type": "rss",
        "dept": "SSB",
        "category": "police",
        "priority": 2,
    ...
    {
        "url": "https://www.rrbchennai.gov.in/rss.xml",
    ...
    {
        "url": "https://www.rrbmumbai.gov.in/rss.xml",
        "fallback_url": "https://www.rrbmumbai.gov.in/",
        "type": "rss",
        "dept": "RRB Mumbai",
        "category": "railway",
        "priority": 2,
    ...
    {
        "url": "https://www.rrballahabad.gov.in/rss.xml",
        "fallback_url": "https://www.rrballahabad.gov.in/",
        "type": "rss",
        "dept": "RRB Allahabad",
        "category": "railway",
        "priority": 2,
